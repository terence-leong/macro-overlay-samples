...
## Production dashboard formats (sanitized)
...
![Recession risk dashboard — synthetic sample](IMG_0007.png)

### Macro Health Index vs Reference Equity
![Macro health index — synthetic sample](IMG_0008.png)

### Froth / Bubble Index with Regime Zones
![Bubble index with regime zones — synthetic sample](IMG_0009.png)

### Market Internals — Heat vs Unwind
![Market internals heat vs unwind — synthetic sample](IMG_0010.png)
